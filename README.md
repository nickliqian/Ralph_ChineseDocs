# Ralph_ChineseDocs
本仓库是开源资产管理系统Ralph文档的翻译内容。
This repository is for translate Ralph docs to Chinese.

[Ralph 3.0 docs](http://ralph-ng.readthedocs.io/en/latest/)
...
我们使用`dh_virtualenv`可以方便的从虚拟环境安装所有的依赖包。然后，我们将deb二进制文件上传到 bintray.com，以方便管理。
